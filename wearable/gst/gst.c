...
/* set to TRUE when don't want to use registry */
gboolean _priv_gst_disable_registry_usage = FALSE;
...
gst_init_get_option_group (void)
{
  ...
  static const GOptionEntry gst_args[] = {
    ...
    {"gst-disable-registry-fork", 0, G_OPTION_FLAG_NO_ARG,
        ...
        NULL},
    {"gst-disable-registry-usage", 0, G_OPTION_FLAG_NO_ARG,
          G_OPTION_ARG_CALLBACK,
          (gpointer) parse_goption_arg,
          N_("No registry use"),
        NULL},
...
parse_one_option (gint opt, const gchar * arg, GError ** err)
{
  switch (opt) {
    ...
    case ARG_REGISTRY_FORK_DISABLE:
      ...
      break;
    case ARG_REGISTRY_USAGE_DISABLE:
	_priv_gst_disable_registry_usage = TRUE;
      break;
    default:
    ...
    const gchar * arg, gpointer data, GError ** err)
{
  static const struct
  {
    ...
    "--gst-disable-registry-usage", ARG_REGISTRY_USAGE_DISABLE}, {
    NULL}
  };
  gint val = 0, n;
